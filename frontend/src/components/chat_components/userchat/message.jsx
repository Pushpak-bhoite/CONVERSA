        ...
        return (
          <div className="chat chat-left" key={props.item._id}>
            <div className="chat-user">
              <img
                src={`${process.env.REACT_APP_IPADDRESS}/uploads/` + props.item.sender._id + "/" + props.item.sender.profile_img}
                alt="avatar"
                className="avatar-35 "
              />
            </div>
          ...
          <div className="chat" key={props.item._id}>
            <div className="chat-detail">
              <div className="chat-message">
                <p>
                  <img 
                    src={`${process.env.REACT_APP_IPADDRESS}/uploads/` + props.item.chat_id + "/" + props.item.message} 
                    className='img-thumbnail' 
                    style={isExpanded ? { height: "300px", width: "300px" } : { height: "100px", width: "100px" }}
