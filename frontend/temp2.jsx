...
function SignUpPage() {
    ...
    function validateForm(data) {
        console.log('profile_pic ==>', data.profile_pic.name)
        if (!data.profile_pic.name || !data.name || !data.email || !data.gender || !data.dob || !data.country || !data.phone_no ||
    ...
    //                                         <input type="text" className="form-control mb-0" id="fname_id" placeholder="Your Full Name" name="name" />
    //                                     </div>
    //                                     <div className="form-group">
    //                                         <label htmlFor="email_id">Email address</label>
    //                                         <input type="email" className="form-control mb-0" id="email_id" placeholder="Enter email" name="email" />
    //                                     </div>
    //                                     <div className="form-group">
    ...
    //                                         <select className="form-control" id="country_id" defaultValue={""} name="country">
    ...
    //                                         <input type="tel" className="form-control mb-0" id="phone_id" placeholder="Enter Phone no." name="phone_no" />
    //                                     </div>
    //                                     <div className="form-group">
    //                                         <label htmlFor="accountTypeRadio">Account Type</label><br />
    //                                         <div className="custom-control custom-radio custom-control-inline">
    //                                             <input type="radio" id="personalRadio" name="type" className="custom-control-input" value="personal" />
    //                                             <label className="custom-control-label" htmlFor="personalRadio">Personal</label>
    //                                         </div>
    //                                         <div className="custom-control custom-radio custom-control-inline">
    //                                             <input type="radio" id="buisnessRadio" name="type" className="custom-control-input" value="business" />
    //                                             <label className="custom-control-label" htmlFor="buisnessRadio">Business</label>
    //                                         </div>
    //                                     </div>
    //                                     <div className="form-group">
    //                                         <label htmlFor="profilePhoto">Profile Photo</label>
    //                                         <input type="file" className="form-control-file" id="profilePhoto" accept="image/*" name="profile_pic" />
    //                                     </div>
    //                                     <div className="form-group">
    ...
    //                                         <input type="password" className="form-control mb-0" id="password_id" placeholder="Password" name="password" />
    //                                     </div>
    //                                     <div className="form-group">
    //                                         <label htmlFor="conf_pass_id">Confirm Password</label>
    //                                         <input type="password" className="form-control mb-0" id="conf_pass_id" placeholder="Confirm Password" name="confirm_password" />
    //                                     </div>
